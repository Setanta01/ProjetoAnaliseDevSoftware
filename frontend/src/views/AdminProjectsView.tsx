  ...
  return (
    <PageContainer className="flex flex-col">
      ...
      <DataPanel className="flex-1 overflow-hidden">
        {isLoading ? <LoadingState /> : filteredProjects.length === 0 ? <EmptyState message={searchTerm ? `Nenhum projeto encontrado para "${searchTerm}"` : 'Nenhum projeto cadastrado ainda.'} /> : (
