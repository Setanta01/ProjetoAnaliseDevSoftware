          ...
          <>
            ...
            <div className="grid h-full min-h-0 md:grid-cols-2">
              <section className="overflow-y-auto bg-card p-8">
                ...
                {task.impedido && task.impedimento_motivo && <div className="mb-6 rounded-lg border border-destructive/25 bg-danger-muted p-4 text-sm text-destructive"><p className="font-semibold">Motivo do bloqueio</p><p className="mt-1 whitespace-pre-wrap leading-relaxed">{task.impedimento_motivo}</p></div>}
